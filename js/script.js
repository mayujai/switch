(function($) {
    ...
    if($('.one-grid-slider-with-nav').length){
        $('.one-grid-slider-with-nav').owlCarousel({
    ...
    if($('.one-grid-slider-with-nav2').length){
        $('.one-grid-slider-with-nav2').owlCarousel({
    ...
    /*  Four-Grid-Owl-carousel  */
    if($('.testimonial_center_rtl').length){
        $('.testimonial_center_rtl').slick({
            autoplay: true,
            autoplaySpeed: 2000,
            dots: false,
            centerMode: true,
